...
Görsel tasarımcılara (tabiki burnu havada olmayanlara) gün geçtikçe daha çok saygı duyuyorum. Tasarımcının azıcık özsaygısı varsa, bu iş sabır olmadan yapılabilecek bir iş değil. Hele de obsesif bir tasarımcının yaşayabileceklerini düşünemiyorum. Bende de hafif bir obsesyon olsa gerek, üzerinde bulunduğunuz websitem için bir icon (tarayıcı sekmelerinde ve bunun gibi birkaç yerde daha görülebilen minik dijital resim) yapmak üzere birkaç saattir tam olarak şu kadar görsel çizdim:

![image](https://i.hizliresim.com/5Ddbkq.png)
<p3>Snowflake Workshop adlı klasörümün son hali</p3>

Şu an bunlardan yalnızca üçü işime yarıyor. Hatta onlardan biri "lazım olursa" fonksiyonuyla bulunuyor. 
