...
<h6 style="text-align: center;"> Ocak 2018 ve Öncesi <a href="http://caglayandemirci.com/monthly-notes/02-18"><i class="right"></i></a></h6>
...
## *
#### Kar Kristali Website İkonu
<p2>22.01.2018</p2>

Görsel tasarımcılara gün geçtikçe daha çok saygı duyuyorum. Tasarımcının azıcık özsaygısı varsa, bu iş sabır olmadan yapılabilecek bir iş değil. Hele de obsesif bir tasarımcının yaşayabileceklerini düşünemiyorum. Bende de hafif bir obsesyon olsa gerek, üzerinde bulunduğunuz websitem için bir icon (tarayıcı sekmelerinde ve bunun gibi birkaç yerde daha görülebilen minik dijital resim) yapmak üzere birkaç saattir, bir iki tanesi birbirinin kopyası desek de aşağı yukarı şu kadar görsel çizdim:

![image](https://i.hizliresim.com/5Ddbkq.png)
<p class="imgdesc">Snowflake Workshop adlı klasörümün son hali</p>

Şu an bunlardan yalnızca üçü işime yarıyor. Hatta onlardan biri "lazım olursa" fonksiyonuyla bulunuyor. Şu andan itibaren son sıranın ikincisi tarayıcı ikonu, ilki ise Hakkımda sayfasında bulunan site simgesi oldu.
...
<img src="https://i.hizliresim.com/PlM1j8.jpg" style="float: right; max-width: 50%; margin: 20px 0 20px 20px;"> 
